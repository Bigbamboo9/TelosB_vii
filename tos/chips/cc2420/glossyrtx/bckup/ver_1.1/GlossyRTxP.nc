...
*/
  ...
  static inline void glossy_sfd_interrupt( uint16_t time ) {
    ...
    */
      ...
      if (T_irq <= 8) {
        ...
        // print_var = m_rx_readbytes;
        // print_var = debug_counter;
        // post print_task();
  ...
  static inline void glossy_end_rx() {
    ...
    if (m_ci_state == S_GLOSSY_RECEIVED) {
      ...
      // call RXFIFO.continueRead( p_buf+m_rx_readbytes, packet_len-m_rx_readbytes );
      // call DirectSpi.read( p_buf+m_rx_readbytes, packet_len-m_rx_readbytes );
      call DirectSpi.continueRead( p_buf+m_rx_readbytes, packet_len-m_rx_readbytes-1 );
    }
  }
...
*/
    ...
    // call TXFIFO.write( (uint8_t*)call CC2420PacketBody.getHeader(m_p_rx_buf), packet_len );
