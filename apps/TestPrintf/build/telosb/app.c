...
extern void *memset(void *arg_0x2b9cd5f22980, int arg_0x2b9cd5f22be8, size_t arg_0x2b9cd5f21020);
#line 65
extern void *memset(void *arg_0x2b9cd5f33b10, int arg_0x2b9cd5f33d78, size_t arg_0x2b9cd5f3a060);
...
struct _reent {
  ...
  void (*__cleanup)(struct _reent *arg_0x2b9cd5f76290);
  ...
  void (**_sig_func)(int arg_0x2b9cd5f7b300);
...
# 83 "/opt/tinyos-main-read-only/tos/interfaces/Leds.nc"
static void TestPrintfC__Leds__led1Toggle(void );
# 64 "/opt/tinyos-main-read-only/tos/lib/timer/Timer.nc"
static void TestPrintfC__Timer__startPeriodic(uint32_t dt);
# 70 "TestPrintfC.nc"
uint8_t TestPrintfC__dummyVar1[8];
uint16_t TestPrintfC__dummyVar2[8];
...
# 28 "../../tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x2b9cd652f458){
#line 28
  switch (arg_0x2b9cd652f458) {
#line 28
    case 0:
#line 28
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x2b9cd652f458);
#line 28
      break;
#line 28
    }
...
# 83 "/opt/tinyos-main-read-only/tos/interfaces/Leds.nc"
inline static void TestPrintfC__Leds__led1Toggle(void ){
#line 83
...
#line 78
{
  ...
  TestPrintfC__Leds__led1Toggle();
  for (i = 0; i < 8; i += 1) {
      TestPrintfC__dummyVar1[i] = 100 + i;
      TestPrintfC__dummyVar2[i] = 2222 + i;
    }
  printf_u8(8, TestPrintfC__dummyVar1);
  printf_u16(8, TestPrintfC__dummyVar2);
  do {
#line 92
...
#line 93
  0);
  TestPrintfC__dummyVar2[0] = t_cap_h1 - t_cap_h0;
  TestPrintfC__dummyVar2[1] = t_cap_l1 - t_cap_l0;
  printf_u16(2, TestPrintfC__dummyVar2);
...
# 83 "/opt/tinyos-main-read-only/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x2b9cd6a155d8){
#line 83
  switch (arg_0x2b9cd6a155d8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x2b9cd6a155d8);
#line 83
      break;
#line 83
    }
...
{
#line 46
  union /*Msp430TimerC.Msp430TimerA0*/Msp430TimerCapComP__0____nesc_unnamed4281 {
#line 46
...
# 75 "/opt/tinyos-main-read-only/tos/interfaces/TaskBasic.nc"
inline static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x2b9cd643e650){
#line 75
  switch (arg_0x2b9cd643e650) {
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x2b9cd643e650);
#line 75
      break;
#line 75
    }
...
# 28 "../../tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x2b9cd652f458){
#line 28
  switch (arg_0x2b9cd652f458) {
#line 28
    case 0:
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x2b9cd652f458);
#line 28
      break;
#line 28
    }
