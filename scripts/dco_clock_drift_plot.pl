...

{
	...
	print gnuout "set ylabel 'Clock Frequency Factor (DCO/32kHz)'\n";
    #print gnuout "set xlabel 'Packet Sequence Number'\n";
    print gnuout "set xlabel 'Time (0.244 ms per tick)'\n";
	print gnuout "set yrange [125:130]\n";
	print gnuout "set xrange [0:3000]\n";
